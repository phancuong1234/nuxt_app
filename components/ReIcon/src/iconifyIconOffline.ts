...
import BuildingFill from "@iconify-icons/ri/building-fill";
import BriefcaseFill from "@iconify-icons/ri/briefcase-fill";
import Store3Fill from "@iconify-icons/ri/store-3-fill";
import MacBookFill from "@iconify-icons/ri/macbook-fill";
import DeviceFill from "@iconify-icons/ri/device-fill";
import Book2Fill from "@iconify-icons/ri/book-2-fill";
import ServerLine from "@iconify-icons/ri/server-line";
import ShareForwardFill from "@iconify-icons/ri/share-forward-fill";
import Calendar2Line from "@iconify-icons/ri/calendar-2-line";
...
addIcon("user", User);
addIcon("lock", Lock);
addIcon("team-fill", TeamFill);
addIcon("apps-fill", AppsFill);
addIcon("building-fill", BuildingFill);
addIcon("briefcase-fill", BriefcaseFill);
addIcon("store-3-fill", Store3Fill);
addIcon("macbook-fill", MacBookFill);
addIcon("device-fill", DeviceFill);
addIcon("book-2-fill", Book2Fill);
addIcon("server-line", ServerLine);
addIcon("share-forward-fill", ShareForwardFill);
addIcon("calendar-2-line", Calendar2Line);
addIcon("phone-line", PhoneLine);
addIcon("profile-line", ProfileLine);
addIcon("arrow-go-back-line", ArrowGoBackLine);
// Font Awesome 4
...
import Start from "@iconify-icons/uil/star";
import CommentHeart from "@iconify-icons/uil/comment-heart";
import Save from "@iconify-icons/uil/save";
addIcon("import", Import);
addIcon("export", Export);
addIcon("density", ArrowsShrinkV);
addIcon("star", Start);
addIcon("save", Save);
addIcon("comment-heart", CommentHeart);
// fluent
